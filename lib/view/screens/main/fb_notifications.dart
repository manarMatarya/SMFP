...
Future<void> firebaseMessagingBackgroundHandler(
  ...
  print('ddd ${remoteMessage.data}');
  print('fff ${remoteMessage.category}');
  print('fffd ${remoteMessage.notification!.title}');
  print('fffe ${remoteMessage.notification!.body}');
}
